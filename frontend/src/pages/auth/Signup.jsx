...
export default function Signup() {
  ...
  const strengthColor = strength <= 1 ? "#c04040" : strength <= 2 ? "#d4a020" : "#6cc030"
  ...
  return (
    <div style={styles.bg}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Start managing your smart farm today.</p>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
            <div style={styles.formGroup}>
              ...
              <input
                type="text" placeholder="Arjun" style={styles.input}
            ...
            <div style={styles.formGroup}>
              ...
              <input
                type="text" placeholder="Reddy" style={styles.input}
                value={form.lastName}
          ...
          <div style={styles.formGroup}>
            ...
            <input
              type="password" placeholder="Min. 8 characters" style={styles.input}
              value={form.password}
            ...
            <div style={{ display: "flex", gap: "4px", marginTop: "6px" }}>
              {[1, 2, 3, 4].map((i) => (
                <div key={i} style={{
                  ...
                  background: i <= strength ? strengthColor : "rgba(80,130,40,0.2)",
...
const styles = {
  ...
  btnPrimary: {
    ...
    fontSize: "15px", fontWeight: "500", cursor: "pointer", marginTop: "4px",
  },
